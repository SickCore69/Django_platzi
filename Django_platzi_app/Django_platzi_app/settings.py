"""
Django settings for Django_platzi_app project.
...
SECRET_KEY = 'django-insecure-q&-1nsh-r-^sbr1y+xrrxe+#37^tepm7y!9zs0kcyvvife5cpb'
...
ROOT_URLCONF = 'Django_platzi_app.urls'
...
WSGI_APPLICATION = 'Django_platzi_app.wsgi.application'
